const DICT = Object.freeze({
    zh: {
        ...
        'toast.configApplied': '配置已应用',
        'toast.applyConfigFailed': '应用配置失败',
        'toast.applyFailed': '应用失败',
        'toast.configLoaded': '配置已加载',
        'toast.configReady': '配置就绪',
        'toast.loadConfigFailed': '加载配置失败',
        'toast.readConfigFailed': '读取配置失败',
        'toast.readConfigTimeout': '读取配置超时',
        'toast.backupFailed': '备份失败',
        'toast.backupReadyDownload': '备份成功，开始下载',
        'toast.importFailed': '导入失败',
        'toast.importSuccess': '导入成功',
        'toast.importSkillFailed': '导入 skill 失败',
        'toast.exportFailed': '导出失败',
        'toast.saveFailed': '保存失败',
        'toast.loadFileFailed': '加载文件失败',
        'toast.nameRequired': '请输入名称',
        'toast.nameExists': '名称已存在',
        'toast.keepOneItem': '至少保留一项',
        'toast.modelRequired': '请输入模型',
        'toast.providerModelRequired': '请选择提供商和模型',
        'toast.apiKeyRequired': '请先配置 API Key',
        'toast.configExists': '配置已存在',
        'toast.unsupportedOperation': '不支持此操作',
        'toast.invalidParams': '参数无效',
        'toast.notShareable': '不可分享',
        'toast.movedToTrash': '已移入回收站',
        'toast.commandGenerationFailed': '生成命令失败',
        'toast.nothingToCopy': '没有可复制内容',
        'toast.nothingToExport': '没有可导出内容',
        'toast.sessionRestored': '会话已恢复',
        'toast.restoreFailed': '恢复失败',
        'toast.purged': '已彻底删除',
        'toast.purgeFailed': '彻底删除失败',
        'toast.trashCleared': '回收站已清空',
        'toast.trashClearFailed': '清空回收站失败',
        'toast.trashLoadFailed': '加载回收站失败',
        'toast.trashCountLoadFailed': '加载回收站数量失败',
        'toast.taskPlanUpdated': '任务计划已更新',
        'toast.taskPlanFailed': '任务计划生成失败',
        'toast.taskPlanHasIssues': '计划存在问题，请先修复再执行',
        'toast.cancelRequested': '已发出取消请求',
        'toast.cancelTaskFailed': '取消任务失败',
        ...
        'config.providerBridgeHint': '{label} 当前复用 Codex Provider / Model 管理链路。',
        'config.localBridge.enabledCount': '已启用 {enabled} / {total}',
        'config.localBridge.poolSettings': '轮询池设置',
        'config.localBridge.poolHint': '勾选参与负载均衡的提供商',
        'config.localBridge.noProviders': '暂无可用上游 provider，请先添加直连 provider',
        'config.transformProvider.title': '通过内建转换适配',
        ...
        'settings.language.meta': '选择 Web UI 的显示语言。语言较多时统一在这里管理。',
        'settings.language.label': '语言',
        'settings.language.hint': '设置会保存到当前浏览器，并立即生效。',
        'settings.language.open': '打开语言设置',
        ...
        'settings.trash.clearShort': '清空',
        'settings.trash.clearing': '清空中...',
        'settings.trash.loading': '正在加载回收站...',
        'settings.trash.empty': '回收站为空',
        'settings.trash.emptyHint': '删除的会话保留 {days} 天后自动清理',
        'settings.trash.count': '{count} 个已删除会话',
        'settings.trash.retentionShort': '{days} 天后自动清理',
        ...
        'settings.trash.loadMoreItems': '加载更多（{count} 条）',
        ...
        'settings.webhook.meta': '配置变更时外发通知',
        ...
        'settings.webhook.modalTitle': 'Webhook 配置',
        'settings.webhook.enabledLabel': '启用状态',
        'settings.webhook.enableToggle': '启用 Webhook',
        'settings.webhook.urlLabel': 'URL',
        ...
        'openclaw.main.kicker': 'OpenClaw 配置',
        'openclaw.main.title': '当前 OpenClaw 配置',
        'openclaw.main.hint': '先编辑或应用当前配置；AGENTS.md 与工作区文件是辅助工具。',
        'openclaw.main.current': '当前',
        'openclaw.main.profiles': '配置数',
        'openclaw.main.active': '当前',
        'openclaw.library.kicker': '配置库',
        'openclaw.library.title': 'OpenClaw 配置',
        'openclaw.tools.title': '辅助工具',
        'openclaw.tools.hint': 'AGENTS.md / Workspace 文件',
        ...
        'openclaw.action.apply': '应用',
        'openclaw.action.editCurrent': '编辑当前配置',
        'openclaw.action.applyCurrent': '应用当前配置',
        'openclaw.action.add': '新增配置',
    ...
    ja: {
        ...
        'common.none': 'なし',
        'toast.operationSuccess': '操作に成功しました',
        ...
        'toast.clipboardReadFailed': 'クリップボードを読み取れません',
        'toast.pasted': '貼り付けました',
        'toast.noChanges': '変更は検出されませんでした',
        'toast.configApplied': '設定を適用しました',
        'toast.applyConfigFailed': '設定の適用に失敗しました',
        'toast.applyFailed': '適用に失敗しました',
        'toast.configLoaded': '設定を読み込みました',
        'toast.configReady': '設定準備完了',
        'toast.loadConfigFailed': '設定の読み込みに失敗しました',
        'toast.readConfigFailed': '設定の読み取りに失敗しました',
        'toast.readConfigTimeout': '設定の読み取りがタイムアウトしました',
        'toast.backupFailed': 'バックアップに失敗しました',
        'toast.backupReadyDownload': 'バックアップ完了、ダウンロードを開始しました',
        'toast.importFailed': 'インポートに失敗しました',
        'toast.importSuccess': 'インポートしました',
        'toast.importSkillFailed': 'skill のインポートに失敗しました',
        'toast.exportFailed': 'エクスポートに失敗しました',
        'toast.saveFailed': '保存に失敗しました',
        'toast.loadFileFailed': 'ファイルの読み込みに失敗しました',
        'toast.nameRequired': '名前を入力してください',
        'toast.nameExists': '名前は既に存在します',
        'toast.keepOneItem': '少なくとも 1 件残してください',
        'toast.modelRequired': 'モデルを入力してください',
        'toast.providerModelRequired': 'プロバイダーとモデルを選択してください',
        'toast.apiKeyRequired': '先に API Key を設定してください',
        'toast.configExists': '設定は既に存在します',
        'toast.unsupportedOperation': 'この操作はサポートされていません',
        'toast.invalidParams': 'パラメーターが無効です',
        'toast.notShareable': '共有できません',
        'toast.movedToTrash': 'ゴミ箱に移動しました',
        'toast.commandGenerationFailed': 'コマンド生成に失敗しました',
        'toast.nothingToCopy': 'コピーできる内容がありません',
        'toast.nothingToExport': 'エクスポートできる内容がありません',
        'toast.sessionRestored': 'セッションを復元しました',
        'toast.restoreFailed': '復元に失敗しました',
        'toast.purged': '完全に削除しました',
        'toast.purgeFailed': '完全削除に失敗しました',
        'toast.trashCleared': 'ゴミ箱を空にしました',
        'toast.trashClearFailed': 'ゴミ箱を空にできませんでした',
        'toast.trashLoadFailed': 'ゴミ箱の読み込みに失敗しました',
        'toast.trashCountLoadFailed': 'ゴミ箱件数の読み込みに失敗しました',
        'toast.taskPlanUpdated': 'タスク計画を更新しました',
        'toast.taskPlanFailed': 'タスク計画の生成に失敗しました',
        'toast.taskPlanHasIssues': '計画に問題があります。実行前に修正してください。',
        'toast.cancelRequested': 'キャンセル要求を送信しました',
        'toast.cancelTaskFailed': 'タスクのキャンセルに失敗しました',
        ...
        'side.plugins.templatesCount': '{count} 個のテンプレート',
        'side.newTab': '新しいタブ',
        ...
        'config.providerBridgeHint': '{label} は現在 Codex Provider / Model 管理フローを再利用しています。',
        'config.localBridge.enabledCount': '有効 {enabled} / {total}',
        'config.localBridge.poolSettings': 'ローテーションプール設定',
        'config.localBridge.poolHint': '負荷分散に参加するプロバイダーを選択します',
        'config.localBridge.noProviders': '利用可能な上流 provider がありません。先に直結 provider を追加してください',
        'config.transformProvider.title': '内蔵変換アダプター経由',
        ...
        'orchestration.readiness.target.done': '目標入力済み',
        'orchestration.readiness.target.missing': '目標が未入力です',
        'orchestration.readiness.engine.label': '実行方針',
        'orchestration.readiness.engine.codex': 'Codex でノードを計画',
        'orchestration.readiness.workflow.done': '{count} 個の Workflow を選択済み',
        'orchestration.readiness.workflow.missing': 'Workflow ID が未指定です',
        'orchestration.readiness.scope.label': '境界',
        'orchestration.readiness.scope.done': '補足説明済み',
        'orchestration.readiness.scope.writeHint': '書き込み前に説明を補うことを推奨',
        'orchestration.readiness.scope.readonlyHint': '読み取り専用なのでそのまま試せます',
        'orchestration.readiness.preview.label': 'プレビュー',
        'orchestration.readiness.preview.missing': 'まだ計画を生成していません',
        'orchestration.readiness.preview.blocked': '{count} 個のブロッカーがあります',
        'orchestration.readiness.preview.ready': '計画使用可能、{count} ノード',
        'orchestration.readiness.empty.title': 'まず目標を書く',
        'orchestration.readiness.empty.summary': '達成したい結果を明確にしてから、オーケストレーターにノード分解させます。',
        'orchestration.readiness.workflow.title': 'Workflow が不足しています',
        'orchestration.readiness.workflow.summary': 'Workflow モードを選択していますが、再利用するフローが未指定です。',
        'orchestration.readiness.preview.title': '先にプレビュー推奨',
        'orchestration.readiness.preview.summary': 'ドラフトはできています。計画を生成してノードと依存関係を確認してから実行してください。',
        'orchestration.readiness.blocked.title': 'プレビューにブロッカーあり',
        'orchestration.readiness.blocked.summary': '現在の計画には {count} 個のブロッカーがあります。先に処理してください。',
        'orchestration.readiness.warn.title': '実行可能ですが注意あり',
        'orchestration.readiness.warn.summary': '計画は生成済みですが、先に確認すべき注意が {count} 件あります。',
        'orchestration.readiness.dryRun.title': 'まずドライランに適しています',
        'orchestration.readiness.dryRun.summary': '安全にドライランして、結果を見てから本実行を判断できます。',
        'orchestration.readiness.ready.title': '実行できます',
        'orchestration.readiness.ready.summary': '主目標は十分明確です。直接実行またはキュー投入できます。',
        'orchestration.readiness.ready.withFollowUps': '主目標と後続作業が揃っています。直接実行またはキュー投入できます。',
        ...
        'settings.language.meta': 'Web UI の表示言語を選択します。言語が増えてもここで管理できます。',
        'settings.language.label': '言語',
        'settings.language.hint': 'この設定は現在のブラウザに保存され、すぐに反映されます。',
        'settings.language.open': '言語設定を開く',
        ...
        'settings.trash.emptyHint': '削除済みセッションは {days} 日後に自動クリーンアップされます',
        'settings.trash.count': '削除済みセッション {count} 件',
        'settings.trash.retentionShort': '{days} 日後に自動クリーンアップ',
        ...
        'settings.trash.loadMoreItems': 'さらに読み込む（{count} 件）',
        ...
        'settings.webhook.title': 'Webhook',
        'settings.webhook.meta': '設定変更時に外部通知を送信します',
        ...
        'settings.webhook.enabledLabel': '有効状態',
        ...
        'openclaw.main.kicker': 'OpenClaw 設定',
        'openclaw.main.title': '現在の OpenClaw 設定',
        'openclaw.main.hint': 'まず現在の設定を編集または適用します。AGENTS.md と Workspace ファイルは補助ツールです。',
        'openclaw.main.current': '現在',
        'openclaw.main.profiles': '設定数',
        'openclaw.main.active': '現在',
        'openclaw.library.kicker': '設定ライブラリ',
        'openclaw.library.title': 'OpenClaw 設定',
        'openclaw.tools.title': '補助ツール',
        'openclaw.tools.hint': 'AGENTS.md / Workspace ファイル',
        ...
        'openclaw.action.apply': '適用',
        'openclaw.action.editCurrent': '現在の設定を編集',
        'openclaw.action.applyCurrent': '現在の設定を適用',
        'openclaw.action.add': '設定を追加',
    ...
    en: {
        ...
        'common.none': 'None',
        'toast.operationSuccess': 'Operation succeeded',
        ...
        'toast.clipboardReadFailed': 'Unable to read clipboard',
        'toast.pasted': 'Pasted',
        'toast.noChanges': 'No changes detected',
        'toast.configApplied': 'Config applied',
        'toast.applyConfigFailed': 'Failed to apply config',
        'toast.applyFailed': 'Apply failed',
        'toast.configLoaded': 'Config loaded',
        'toast.configReady': 'Config ready',
        'toast.loadConfigFailed': 'Failed to load config',
        'toast.readConfigFailed': 'Failed to read config',
        'toast.readConfigTimeout': 'Reading config timed out',
        'toast.backupFailed': 'Backup failed',
        'toast.backupReadyDownload': 'Backup complete, download started',
        'toast.importFailed': 'Import failed',
        'toast.importSuccess': 'Imported successfully',
        'toast.importSkillFailed': 'Skill import failed',
        'toast.exportFailed': 'Export failed',
        'toast.saveFailed': 'Save failed',
        'toast.loadFileFailed': 'Failed to load file',
        'toast.nameRequired': 'Enter a name',
        'toast.nameExists': 'Name already exists',
        'toast.keepOneItem': 'Keep at least one item',
        'toast.modelRequired': 'Enter a model',
        'toast.providerModelRequired': 'Select a provider and model',
        'toast.apiKeyRequired': 'Configure the API key first',
        'toast.configExists': 'Config already exists',
        'toast.unsupportedOperation': 'Unsupported operation',
        'toast.invalidParams': 'Invalid parameters',
        'toast.notShareable': 'Not shareable',
        'toast.movedToTrash': 'Moved to trash',
        'toast.commandGenerationFailed': 'Failed to generate command',
        ...
        'toast.purgeFailed': 'Permanent delete failed',
        'toast.trashCleared': 'Trash emptied',
        'toast.trashClearFailed': 'Failed to empty trash',
        'toast.trashLoadFailed': 'Failed to load trash',
        'toast.trashCountLoadFailed': 'Failed to load trash count',
        'toast.taskPlanUpdated': 'Task plan updated',
        'toast.taskPlanFailed': 'Failed to generate task plan',
        'toast.taskPlanHasIssues': 'The plan has issues. Fix them before running.',
        'toast.cancelRequested': 'Cancel request sent',
        'toast.cancelTaskFailed': 'Failed to cancel task',
        ...
        'config.providerBridgeHint': '{label} currently reuses the Codex Provider / Model management flow.',
        'config.localBridge.enabledCount': 'Enabled {enabled} / {total}',
        'config.localBridge.poolSettings': 'Rotation pool settings',
        'config.localBridge.poolHint': 'Select providers that participate in load balancing',
        'config.localBridge.noProviders': 'No upstream provider is available. Add a direct provider first.',
        'config.transformProvider.title': 'Adapted through the built-in transform',
        ...
        'orchestration.readiness.target.label': 'Goal',
        'orchestration.readiness.target.done': 'Goal entered',
        'orchestration.readiness.target.missing': 'Goal missing',
        'orchestration.readiness.engine.label': 'Execution strategy',
        'orchestration.readiness.engine.codex': 'Use Codex to plan nodes',
        'orchestration.readiness.workflow.done': '{count} workflows selected',
        'orchestration.readiness.workflow.missing': 'Workflow ID missing',
        'orchestration.readiness.scope.label': 'Scope',
        'orchestration.readiness.scope.done': 'Notes added',
        'orchestration.readiness.scope.writeHint': 'Add notes before allowing writes',
        'orchestration.readiness.scope.readonlyHint': 'Read-only mode is safe to try',
        'orchestration.readiness.preview.label': 'Preview',
        'orchestration.readiness.preview.missing': 'Plan not generated yet',
        'orchestration.readiness.preview.blocked': '{count} blockers',
        'orchestration.readiness.preview.ready': 'Plan ready, {count} nodes',
        'orchestration.readiness.empty.title': 'Start with a goal',
        'orchestration.readiness.empty.summary': 'Describe the result you want before asking the orchestrator to split it into nodes.',
        ...
        'orchestration.readiness.preview.summary': 'The draft is ready. Generate a plan first to confirm nodes and dependencies before running.',
        'orchestration.readiness.blocked.title': 'Preview has blockers',
        'orchestration.readiness.blocked.summary': 'The current plan still has {count} blockers. Resolve them first.',
        'orchestration.readiness.warn.title': 'Runnable with warnings',
        'orchestration.readiness.warn.summary': 'The plan is generated, but {count} warnings are worth checking first.',
        'orchestration.readiness.dryRun.title': 'Good for a dry run',
        'orchestration.readiness.dryRun.summary': 'You can safely run a dry run first, inspect the result, then decide whether to execute.',
        'orchestration.readiness.ready.title': 'Ready to run',
        'orchestration.readiness.ready.summary': 'The main goal is clear enough to run directly or queue.',
        'orchestration.readiness.ready.withFollowUps': 'The main goal and follow-ups are ready; run directly or queue.',
        ...
        'settings.language.meta': 'Choose the Web UI display language. Additional languages are managed here instead of the sidebar.',
        'settings.language.label': 'Language',
        'settings.language.hint': 'This setting is saved in the current browser and applies immediately.',
        'settings.language.open': 'Open language settings',
        ...
        'settings.trash.clearShort': 'Empty',
        'settings.trash.clearing': 'Clearing...',
        'settings.trash.loading': 'Loading trash...',
        'settings.trash.empty': 'Trash is empty',
        'settings.trash.emptyHint': 'Deleted sessions are auto-purged after {days} days',
        'settings.trash.count': '{count} deleted sessions',
        'settings.trash.retentionShort': 'Auto-purge after {days} days',
        ...
        'settings.trash.loadMoreItems': 'Load more ({count})',
        ...
        'settings.webhook.title': 'Webhook',
        'settings.webhook.meta': 'Send outgoing notifications when config changes',
        ...
        'settings.webhook.enabledLabel': 'Enabled state',
        ...
        'openclaw.main.kicker': 'OpenClaw config',
        'openclaw.main.title': 'Current OpenClaw config',
        'openclaw.main.hint': 'Edit or apply the current config first. AGENTS.md and Workspace files are helper tools.',
        'openclaw.main.current': 'Current',
        'openclaw.main.profiles': 'Profiles',
        'openclaw.main.active': 'Active',
        'openclaw.library.kicker': 'Config library',
        'openclaw.library.title': 'OpenClaw configs',
        'openclaw.tools.title': 'Helper tools',
        'openclaw.tools.hint': 'AGENTS.md / Workspace files',
        ...
        'openclaw.action.apply': 'Apply',
        'openclaw.action.editCurrent': 'Edit current config',
        'openclaw.action.applyCurrent': 'Apply current config',
        'openclaw.action.add': 'Add config',

const zh = Object.freeze({
    ...
    'side.plugins.pluginsCount': '{count} 个插件',
    ...
    'plugins.catalog.textTools.title': '文本工具',
    'plugins.catalog.textTools.description': '面向开发者的字符串工具集：空白压缩、去重/排序/反转、大小写、Base64、JSON、时间戳与进制转换。',
    'plugins.textTools.title': '文本工具',
    'plugins.textTools.inputLabel': '输入',
    'plugins.textTools.inputPlaceholder': '在此粘贴或输入文本...',
    'plugins.textTools.outputLabel': '输出',
    'plugins.textTools.outputPlaceholder': '结果将显示在这里',
    'plugins.textTools.swap': '交换输入/输出',
    'plugins.textTools.clear': '清空',
    'plugins.textTools.stats.chars': '字符',
    'plugins.textTools.stats.lines': '行',
    'plugins.textTools.stats.words': '词',
    'plugins.textTools.stats.bytes': '字节',
    'plugins.textTools.group.whitespace': '空白 / 压缩',
    'plugins.textTools.group.text': '文本处理',
    'plugins.textTools.group.case': '大小写转换',
    'plugins.textTools.group.encode': '编码',
    'plugins.textTools.group.format': '格式化',
    'plugins.textTools.group.convert': '数值 / 时间转换',
    'plugins.textTools.tool.removeSpaces': '去空格',
    'plugins.textTools.tool.removeNewlines': '去换行',
    'plugins.textTools.tool.removeBlankLines': '删空行',
    'plugins.textTools.tool.removeCR': '去回车',
    'plugins.textTools.tool.removeTabs': '去制表符',
    'plugins.textTools.tool.compressAll': '压缩全部空白',
    'plugins.textTools.tool.dedupeLines': '行去重',
    'plugins.textTools.tool.sortLines': '行排序',
    'plugins.textTools.tool.reverseText': '文本反转',
    'plugins.textTools.tool.toUpperCase': '转大写',
    'plugins.textTools.tool.toLowerCase': '转小写',
    'plugins.textTools.tool.titleCase': '首字母大写',
    'plugins.textTools.tool.camelToSnake': '驼峰转下划线',
    'plugins.textTools.tool.snakeToCamel': '下划线转驼峰',
    'plugins.textTools.tool.base64Encode': 'Base64 编码',
    'plugins.textTools.tool.base64Decode': 'Base64 解码',
    'plugins.textTools.tool.jsonBeautify': 'JSON 美化',
    'plugins.textTools.tool.jsonMinify': 'JSON 压缩',
    'plugins.textTools.tool.timestampToDate': '时间戳转日期',
    'plugins.textTools.tool.dateToTimestamp': '日期转时间戳',
    'plugins.textTools.tool.decToHex': '十进制转十六进制',
    'plugins.textTools.tool.hexToDec': '十六进制转十进制',
    'plugins.textTools.error.unknownTool': '未知工具',
    'plugins.textTools.error.invalidInput': '输入无效，无法处理',
    ...
    'toast.history.restored': '已恢复到编辑器，保存后生效',
    'toast.history.empty': '暂无历史',
    ...
    'sessions.batch.select': '批量删除',
    'sessions.batch.exit': '退出选择',
    'sessions.batch.selectAll': '全选',
    'sessions.batch.unselectAll': '取消全选',
    'sessions.batch.deleteSelected': '删除选中',
    'sessions.batch.deleteSelectedN': '删除选中（{count}）',
    'sessions.batch.deletingSelected': '删除中...',
    'sessions.batch.deleteConfirm': '确定删除选中的 {count} 个会话吗？',
    'sessions.batch.deleteConfirmHard': '确定永久删除选中的 {count} 个会话吗？该操作不可恢复。',
    'sessions.batch.deleteHint': '已选 {count} 个',
    'sessions.batch.emptySelection': '请先选择要删除的会话',
    'sessions.batch.partialFail': '其中 {failed} 个删除失败，已保留选中',
    'sessions.batch.allFail': '删除失败，请重试',
    ...
    'sessions.preview.copyMessage': '复制记录',
    ...
    'usage.kpi.tokens': '总 Token',
    'usage.kpi.sessions': '会话数',
    'usage.kpi.messages': '消息数',
    'usage.kpi.dailyAvg': '日均 Token',
    'usage.kpi.busiestDay': '最忙日',
    'usage.wave.summary': '本期共 {total} · 峰值 {peakDay}（{peakValue}）',
    ...
    'config.localBridge.poolHint': '选择参与负载均衡的候选提供商。',
    'config.localBridge.noProviders': '暂无可用候选提供商，请先添加直连提供商。',
    'config.transformProvider.title': '使用转换提供商',
    'config.providerBridgeHint': '{label} 桥接模式',
    ...
    'status.kilocodeProvider': 'Kilocode 提供商',
    'status.kilocodeModel': 'Kilocode 模型',
    'status.piProvider': 'Pi 提供商',
    'status.piModel': 'Pi 模型',
    ...
    'settings.trash.count': '共 {count} 项',
    'settings.trash.retentionShort': '保留 {days} 天',
    'settings.trash.disabled': '回收站已关闭',
    'settings.trash.disabledHint': '已删除的会话将直接永久删除，不再进入回收站。',
    'settings.trash.clearShort': '清空',
    'settings.trash.loadMoreItems': '加载更多（剩余 {count} 项）',
...
,
    ...
    'toolConfig.openclaw.title': 'OpenClaw 配置写入',
    'toolConfig.openclaw.desc': '默认只读；开启后可应用 OpenClaw 配置、写入 AGENTS.md 与其他工作区文件。',
    'toolConfig.openclaw.confirmMessage': '打开后，OpenClaw tab 内的操作会写入 openclaw.json 及 OpenClaw 工作区文件（AGENTS.md、SOUL.md 等）。',
    'toolConfig.openclaw.lockedTitle': 'OpenClaw 当前为只读',
    'toolConfig.openclaw.lockedDesc': '这里不会写入 OpenClaw 配置。要应用配置或编辑工作区文件，请先打开本 tab 的写入开关。',
    'side.config.pi': 'Pi',
    'side.config.pi.meta': '配置',
    'toolConfig.pi.title': 'Pi 配置写入',
    'toolConfig.pi.desc': '默认只读；开启后可同步 Pi 配置。',
    'toolConfig.pi.lockedTitle': '只读模式',
    'toolConfig.pi.lockedDesc': '开启写入权限后可同步 Pi 配置。',
    'toolConfig.pi.confirmMessage': '打开后，Pi tab 内的操作会写入 ~/.pi/config.json 或项目内的 ./.pi/config.json。',
    'pi.status.readOnly': '只读',
    'pi.config.openGlobal': '打开全局配置',
    'pi.providers.title': 'Pi 供应商',
    'pi.providers.subtitle': '管理 Piper 本地供应商与模型',
    'pi.providers.empty': '未找到 Piper 供应商，点击添加开始。',
    'pi.providers.targetFile': 'Pi 生效配置文件：{path}',
    ...
    'pi.providers.json.title': '配置 JSON',
    'pi.providers.json.desc': '实时预览表单改动合并后的最终记录；保存时并入 models.json。',
    'pi.providers.json.previewTitle': '预览',
    'pi.providers.json.editTitle': '编辑 JSON',
    'pi.files.title': '文件 JSON',
    ...
    'pi.providers.models.remoteLoading': '正在获取远端模型列表…',
    'pi.providers.models.remoteFailed': '可手动输入模型 ID。',
    'pi.providers.models.noMatch': '无匹配模型',
    'pi.providers.models.importTitle': '从端点导入模型',
    'pi.providers.models.addSelected': '添加选中（{count}）',
    'pi.providers.models.name': '名称',
    'pi.providers.models.reasoning': '支持推理',
    'pi.providers.models.contextWindow': '上下文窗口',
    'pi.providers.models.maxTokens': '最大输出',
    'pi.providers.models.catalogFill': '自动填充',
    'pi.providers.models.catalogFilling': '填充中…',
    'pi.picker.searchPlaceholder': '搜索供应商…',
    'pi.picker.group.custom': '自定义端点',
    'pi.picker.group.apiKey': 'API Key 服务商',
    'pi.picker.empty': '没有匹配的供应商模板',
    'pi.picker.back': '返回选择模板',
    'pi.providers.delete': '删除供应商',
    'pi.providers.addModal.title': '添加供应商',
    'pi.providers.addModal.subtitle': '创建新的 Piper 供应商',
    'pi.providers.addModal.fields.baseUrl': 'Base URL',
    'pi.providers.addModal.fields.apiKey': 'API Key',
    'pi.providers.addModal.api.openaiCompletions': 'OpenAI Chat Completions（最兼容）',
    ...
    'pi.providers.addModal.fields.api': '接口格式',

const zh = Object.freeze({
    ...
    'announcement.providerCache.open': '缓存公告',
    'announcement.providerCache.title': '缓存公告',
    'announcement.providerCache.subtitle': '这里汇总 ~/.codexmate 内的 provider 缓存状态；可从当前配置同步缓存记录。敏感字段只显示遮罩值。',
    'announcement.providerCache.summary.files': '缓存文件',
    'announcement.providerCache.summary.providers': 'Provider',
    'announcement.providerCache.summary.groups': '分组',
    'announcement.providerCache.groupList': '缓存分组摘要',
    'announcement.providerCache.groupSummary': '{files} 文件 · {providers} provider',
    'announcement.providerCache.details': '查看详情',

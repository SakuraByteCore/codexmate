const zh = Object.freeze({
    ...
    'prompts.presets.title': 'Prompt 通用预设池',
    'prompts.presets.hint': '把可复用的 prompt 内容保存在这里，再应用到 AGENTS.md 或 CLAUDE.md。应用预设只更新编辑器，仍需点击保存才会写入文件。',
    'prompts.presets.namePlaceholder': '预设名称',
    'prompts.presets.saveCurrent': '保存当前内容为预设',
    'prompts.presets.empty': '暂无预设。先打开 AGENTS.md 或 CLAUDE.md 编辑内容，再保存为预设。',
    'prompts.presets.updatedAt': '更新时间：{time}',
    'prompts.presets.renameAria': '重命名 prompt 预设',
    'prompts.presets.applyAgents': '应用到 AGENTS.md',
    'prompts.presets.applyClaude': '应用到 CLAUDE.md',
    ...
    'prompts.presets.confirm.addCurrentMessage': '将当前编辑器内容作为“{name}”添加到预设池。不会保存 md 文件。',
    ...
    'prompts.presets.confirm.applyTitle': '替换当前编辑器内容？',
    'prompts.presets.confirm.applyMessage': '当前编辑器存在未保存改动。应用预设会替换编辑器内容，但不会写入文件，仍需点击保存。',
    'prompts.presets.confirm.applyConfirm': '应用预设',
    ...
    'prompts.presets.toast.applied': '预设已应用到编辑器，点击保存后才会写入文件。',

const zh = Object.freeze({
    ...
    'prompts.editor.bold': '加粗',
    'prompts.editor.list': '列表',
    'prompts.editor.code': '代码块',
    'prompts.editor.undo': '撤销',
    'prompts.editor.previewToggle': '实时预览',
    'prompts.editor.edit': '编辑',
    'prompts.editor.preview': '预览',
    'prompts.editor.previewUnavailable': '预览组件未加载（marked / DOMPurify 缺失），请刷新页面',
    ...
    'toast.agents.saved.opencode': 'OpenCode AGENTS.md 已保存',
    ...
    'modal.agents.title.opencode': 'OpenCode AGENTS.md 编辑器',
    ...
    'modal.agents.hint.opencode': '保存后会写入 ~/.config/opencode/AGENTS.md。',

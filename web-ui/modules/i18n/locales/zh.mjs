const zh = Object.freeze({
    ...
    'toolConfig.opencode.desc': '默认只读展示 OpenCode 配置；打开后才允许写入 ~/.opencode.json。',
    ...
    'toolConfig.opencode.confirmMessage': '打开后，OpenCode tab 内的操作会写入 ~/.opencode.json 或 XDG OpenCode 配置文件。',

const zh = Object.freeze({
    ...
    'announcement.project.subtitle': '用一分钟建立对当前工作台的认知：它把配置、会话、用量、任务、Skills 和数据维护收在同一个地方。',
    'announcement.project.features.aria': 'Codex Mate 功能概览',
    'announcement.project.feature.config.title': '统一配置',
    'announcement.project.feature.config.meta': '管理 Codex / Claude / OpenClaw / OpenCode 的 Provider、模型与本地配置。',
    'announcement.project.feature.sessions.title': '会话浏览',
    'announcement.project.feature.sessions.meta': '按来源查看、搜索、导出、清理会话，快速回到上下文。',
    'announcement.project.feature.usage.title': '用量统计',
    'announcement.project.feature.usage.meta': '查看近 7 天、30 天或全部本地用量趋势。',
    'announcement.project.feature.tasks.title': '任务编排',
    'announcement.project.feature.tasks.meta': '把复杂工作拆成计划、队列和运行记录，方便追踪。',
    'announcement.project.feature.skills.title': 'Skills / 插件',
    'announcement.project.feature.skills.meta': '管理本地 Skills 与提示词模板，让常用工作流可复用。',
    'announcement.project.feature.data.title': '数据维护',
    'announcement.project.feature.data.meta': '处理备份、导入、回收站和 Provider 缓存同步。',
    'announcement.project.status.aria': '当前工作台状态',
    'announcement.project.status.provider': '当前 Provider',
    'announcement.project.status.model': '当前模型',
    'announcement.project.status.cacheFiles': '缓存文件',
    'announcement.project.cache.title': 'Provider 缓存同步',
    'announcement.project.cache.meta': '缓存摘要只是健康状态的一部分：同步后可被 Claude / Codex / OpenCode 配置视图复用，敏感字段继续遮罩。',

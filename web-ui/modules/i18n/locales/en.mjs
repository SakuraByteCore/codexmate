const en = Object.freeze({
    ...
    'toolConfig.opencode.desc': 'OpenCode config is read-only by default; enable this before writing ~/.opencode.json.',
    ...
    'toolConfig.opencode.confirmMessage': 'After enabling this, actions in the OpenCode tab may write ~/.opencode.json or the XDG OpenCode config file.',

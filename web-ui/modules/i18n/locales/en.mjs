const en = Object.freeze({
    ...
    'prompts.presets.applyAgents': 'Apply to AGENTS.md',
    'prompts.presets.applyClaude': 'Apply to CLAUDE.md',
    ...
    'prompts.presets.confirm.addCurrentMessage': 'Add the current editor content to the preset pool as “{name}”. This will not save the md file.',
    ...
    'prompts.presets.confirm.applyTitle': 'Replace current editor content?',
    'prompts.presets.confirm.applyMessage': 'The current editor has unsaved changes. Applying this preset will replace the editor content, but it will not write the file until you click Save.',
    'prompts.presets.confirm.applyConfirm': 'Apply preset',
    ...
    'prompts.presets.toast.applied': 'Preset applied to editor. Click Save to write the file.',

const en = Object.freeze({
    ...
    'opencode.applySelection': 'Apply selection',
    'opencode.targetFile': 'Target file: {path} · {status}',
    ...
    'opencode.configFile.hint': 'Import existing OpenCode JSON/JSONC config; content is parsed before saving to avoid writing invalid config.',

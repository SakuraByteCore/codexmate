const en = Object.freeze({
    ...
    'usage.kpi.filesChanged': 'Files changed',
    'usage.kpi.linesChanged': 'Lines changed',
    'usage.kpi.statsCoverage': 'Computed {computed}/{total}',
    'usage.kpi.statsUnavailable': 'Stats unavailable',

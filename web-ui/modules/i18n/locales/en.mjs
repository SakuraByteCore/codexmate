const en = Object.freeze({
    ...
    'common.restoreToEditor': 'Restore to editor',
    ...
    'side.config.openclaw.meta': 'Config',
    ...
    'side.plugins.pluginsCount': '{count} plugins',
    ...
    'plugins.catalog.textTools.title': 'Text Tools',
    'plugins.catalog.textTools.description': 'Developer-oriented string utilities: whitespace compression, dedupe/sort/reverse, case conversion, Base64, JSON, timestamp and radix conversion.',
    'plugins.textTools.title': 'Text Tools',
    'plugins.textTools.inputLabel': 'Input',
    'plugins.textTools.inputPlaceholder': 'Paste or type text here...',
    'plugins.textTools.outputLabel': 'Output',
    'plugins.textTools.outputPlaceholder': 'Result will appear here',
    'plugins.textTools.swap': 'Swap input/output',
    'plugins.textTools.clear': 'Clear',
    'plugins.textTools.stats.chars': 'Characters',
    'plugins.textTools.stats.lines': 'Lines',
    'plugins.textTools.stats.words': 'Words',
    'plugins.textTools.stats.bytes': 'Bytes',
    'plugins.textTools.group.whitespace': 'Whitespace',
    'plugins.textTools.group.text': 'Text',
    'plugins.textTools.group.case': 'Case',
    'plugins.textTools.group.encode': 'Encode',
    'plugins.textTools.group.format': 'Format',
    'plugins.textTools.group.convert': 'Convert',
    'plugins.textTools.tool.removeSpaces': 'Remove spaces',
    'plugins.textTools.tool.removeNewlines': 'Remove newlines',
    'plugins.textTools.tool.removeBlankLines': 'Remove blank lines',
    'plugins.textTools.tool.removeCR': 'Remove CR',
    'plugins.textTools.tool.removeTabs': 'Remove tabs',
    'plugins.textTools.tool.compressAll': 'Compress all whitespace',
    'plugins.textTools.tool.dedupeLines': 'Dedupe lines',
    'plugins.textTools.tool.sortLines': 'Sort lines',
    'plugins.textTools.tool.reverseText': 'Reverse text',
    'plugins.textTools.tool.toUpperCase': 'To uppercase',
    'plugins.textTools.tool.toLowerCase': 'To lowercase',
    'plugins.textTools.tool.titleCase': 'Title case',
    'plugins.textTools.tool.camelToSnake': 'camelCase to snake_case',
    'plugins.textTools.tool.snakeToCamel': 'snake_case to camelCase',
    'plugins.textTools.tool.base64Encode': 'Base64 encode',
    'plugins.textTools.tool.base64Decode': 'Base64 decode',
    'plugins.textTools.tool.jsonBeautify': 'JSON beautify',
    'plugins.textTools.tool.jsonMinify': 'JSON minify',
    'plugins.textTools.tool.timestampToDate': 'Timestamp to date',
    'plugins.textTools.tool.dateToTimestamp': 'Date to timestamp',
    'plugins.textTools.tool.decToHex': 'Decimal to hex',
    'plugins.textTools.tool.hexToDec': 'Hex to decimal',
    'plugins.textTools.error.unknownTool': 'Unknown tool',
    'plugins.textTools.error.invalidInput': 'Invalid input',
    ...
    'toast.history.restored': 'Restored to editor, save to confirm',
    ...
    'sessions.batch.select': 'Batch delete',
    'sessions.batch.exit': 'Exit selection',
    'sessions.batch.selectAll': 'Select all',
    'sessions.batch.unselectAll': 'Clear selection',
    'sessions.batch.deleteSelected': 'Delete selected',
    'sessions.batch.deleteSelectedN': 'Delete selected ({count})',
    'sessions.batch.deletingSelected': 'Deleting...',
    'sessions.batch.deleteConfirm': 'Delete the {count} selected sessions?',
    'sessions.batch.deleteConfirmHard': 'Permanently delete the {count} selected sessions? This cannot be undone.',
    'sessions.batch.deleteHint': '{count} selected',
    'sessions.batch.emptySelection': 'Select sessions to delete first',
    'sessions.batch.partialFail': '{failed} failed to delete; selection kept',
    'sessions.batch.allFail': 'Delete failed, please retry',
    ...
    'usage.kpi.tokens': 'Total tokens',
    'usage.kpi.sessions': 'Sessions',
    'usage.kpi.messages': 'Messages',
    'usage.kpi.dailyAvg': 'Avg tokens / day',
    'usage.kpi.busiestDay': 'Busiest day',
    'usage.wave.summary': '{total} total · peak {peakDay} ({peakValue})',
    ...
    'status.kilocodeProvider': 'Kilocode provider',
    'status.kilocodeModel': 'Kilocode model',
    'status.piProvider': 'Pi provider',
    'status.piModel': 'Pi model',
...
,
    ...
    'side.config.kilocode.meta': 'Provider',
    'toolConfig.kilocode.title': 'KiloCode config writes and launch',
    'toolConfig.kilocode.desc': 'Read-only by default; enable writes to sync KiloCode config and launch it from the Web UI.',
    ...
    'side.config.pi': 'Pi',
    'side.config.pi.meta': 'Config',
    'toolConfig.pi.title': 'Pi config writes',
    'toolConfig.pi.desc': 'Read-only by default; enable to sync Pi config.',
    'toolConfig.pi.lockedTitle': 'Read-only',
    'toolConfig.pi.lockedDesc': 'Enable write access to sync Pi config.',
    'toolConfig.pi.confirmMessage': 'When enabled, actions in the Pi tab can write the Pi config file (~/.pi/config.json or ./.pi/config.json).',
    'pi.status.readOnly': 'Read-only',
    'pi.config.openGlobal': 'Open global config',
    'pi.providers.title': 'Pi Providers',
    'pi.providers.subtitle': 'Manage Piper local providers and models',
    'pi.providers.empty': 'No providers found. Click Add to start.',
    'pi.providers.targetFile': 'Active Pi config file: {path}',
    ...
    'pi.providers.json.title': 'Config JSON',
    'pi.providers.json.desc': 'Live preview of the final provider record merged from form changes and extras; edits are merged into models.json on save.',
    ...
    'pi.providers.models.remoteLoading': 'Fetching remote model list…',
    'pi.providers.models.remoteFailed': 'You can still type model IDs manually.',
    'pi.providers.models.noMatch': 'No matching models',
    'pi.providers.models.importTitle': 'Import models from endpoint',
    'pi.providers.models.addSelected': 'Add selected ({count})',
    'pi.providers.models.name': 'Name',
    'pi.providers.models.reasoning': 'Supports reasoning',
    'pi.providers.models.contextWindow': 'Context window',
    'pi.providers.models.maxTokens': 'Max output',
    'pi.providers.models.catalogFill': 'Auto-fill',
    'pi.providers.models.catalogFilling': 'Filling…',
    'pi.picker.searchPlaceholder': 'Search providers…',
    'pi.picker.group.custom': 'Custom endpoint',
    'pi.picker.group.apiKey': 'API key providers',
    'pi.picker.empty': 'No matching provider templates',
    'pi.picker.back': 'Back to template selection',
    'pi.providers.delete': 'Delete Provider',
    'pi.providers.addModal.title': 'Add Provider',
    'pi.providers.addModal.subtitle': 'Create a new Piper provider',
    'pi.providers.addModal.fields.baseUrl': 'Base URL',
    'pi.providers.addModal.fields.apiKey': 'API Key',
    'pi.providers.addModal.api.openaiCompletions': 'OpenAI Chat Completions (most compatible)',
    ...
    'pi.providers.addModal.fields.api': 'API Format',
    ...
    'kilocode.saveConfig': 'Save config',
    'kilocode.start': 'Launch KiloCode',
    'kilocode.starting': 'Launching',
    'kilocode.saveAndStart': 'Save and launch',
    'kilocode.summary.title': 'Current KiloCode provider',
    'kilocode.configPreview.title': 'KiloCode config preview',
    'kilocode.configPreview.hint': 'API Key is redacted; auto-sync writes the real key.',
    'kilocode.saveFailed': 'Failed to save KiloCode config',
    'kilocode.fillRequired': 'Fill KiloCode URL and API Key',

const en = Object.freeze({
    ...
    'announcement.project.title': 'Codex Mate quick guide',
    'announcement.project.subtitle': 'Build a working picture in one minute: this workspace brings configuration, sessions, usage, tasks, Skills, and data maintenance into one place.',
    'announcement.project.features.aria': 'Codex Mate feature overview',
    'announcement.project.feature.config.title': 'Unified configuration',
    'announcement.project.feature.config.meta': 'Manage providers, models, and local configs for Codex, Claude, OpenClaw, and OpenCode.',
    'announcement.project.feature.sessions.title': 'Session browser',
    'announcement.project.feature.sessions.meta': 'Browse, search, export, and clean sessions by source so context is easy to recover.',
    'announcement.project.feature.usage.title': 'Usage analytics',
    'announcement.project.feature.usage.meta': 'Inspect local usage trends for the last 7 days, 30 days, or all time.',
    'announcement.project.feature.tasks.title': 'Task orchestration',
    'announcement.project.feature.tasks.meta': 'Break complex work into plans, queues, and run records for traceability.',
    'announcement.project.feature.skills.title': 'Skills / Plugins',
    'announcement.project.feature.skills.meta': 'Manage local Skills and prompt templates so recurring workflows stay reusable.',
    'announcement.project.feature.data.title': 'Data maintenance',
    'announcement.project.feature.data.meta': 'Handle backups, imports, trash, and provider cache synchronization.',
    'announcement.project.status.aria': 'Current workspace status',
    'announcement.project.status.provider': 'Current provider',
    'announcement.project.status.model': 'Current model',
    'announcement.project.status.cacheFiles': 'Cache files',
    'announcement.project.cache.title': 'Provider cache sync',
    'announcement.project.cache.meta': 'The cache summary is only one health signal. After sync, Claude / Codex / OpenCode config views can reuse these records while sensitive fields stay redacted.',

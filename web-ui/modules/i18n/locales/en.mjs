const en = Object.freeze({
    ...
    'announcement.providerCache.open': 'Cache announcements',
    'announcement.providerCache.title': 'Cache announcements',
    'announcement.providerCache.subtitle': 'This summarizes provider cache status under ~/.codexmate. You can sync cache records from the current configuration; sensitive fields stay redacted.',
    'announcement.providerCache.summary.files': 'Cache files',
    'announcement.providerCache.summary.providers': 'Providers',
    'announcement.providerCache.summary.groups': 'Groups',
    'announcement.providerCache.groupList': 'Cache group summary',
    'announcement.providerCache.groupSummary': '{files} files · {providers} providers',
    'announcement.providerCache.details': 'View details',

const zhTw = Object.freeze({
    ...
    'side.plugins.pluginsCount': '{count} 個插件',
    ...
    'plugins.catalog.textTools.title': '文字工具',
    'plugins.catalog.textTools.description': '面向開發者的字串工具集：空白壓縮、去重/排序/反轉、大小寫、Base64、JSON、時間戳與進制轉換。',
    'plugins.textTools.title': '文字工具',
    'plugins.textTools.inputLabel': '輸入',
    'plugins.textTools.inputPlaceholder': '在此貼上或輸入文字...',
    'plugins.textTools.outputLabel': '輸出',
    'plugins.textTools.outputPlaceholder': '結果將顯示在這裡',
    'plugins.textTools.swap': '交換輸入/輸出',
    'plugins.textTools.clear': '清空',
    'plugins.textTools.stats.chars': '字元',
    'plugins.textTools.stats.lines': '行',
    'plugins.textTools.stats.words': '詞',
    'plugins.textTools.stats.bytes': '位元組',
    'plugins.textTools.group.whitespace': '空白 / 壓縮',
    'plugins.textTools.group.text': '文字處理',
    'plugins.textTools.group.case': '大小寫轉換',
    'plugins.textTools.group.encode': '編碼',
    'plugins.textTools.group.format': '格式化',
    'plugins.textTools.group.convert': '數值 / 時間轉換',
    'plugins.textTools.tool.removeSpaces': '去空格',
    'plugins.textTools.tool.removeNewlines': '去換行',
    'plugins.textTools.tool.removeBlankLines': '刪空行',
    'plugins.textTools.tool.removeCR': '去回車',
    'plugins.textTools.tool.removeTabs': '去製表符',
    'plugins.textTools.tool.compressAll': '壓縮全部空白',
    'plugins.textTools.tool.dedupeLines': '行去重',
    'plugins.textTools.tool.sortLines': '行排序',
    'plugins.textTools.tool.reverseText': '文字反轉',
    'plugins.textTools.tool.toUpperCase': '轉大寫',
    'plugins.textTools.tool.toLowerCase': '轉小寫',
    'plugins.textTools.tool.titleCase': '首字母大寫',
    'plugins.textTools.tool.camelToSnake': '駝峰轉底線',
    'plugins.textTools.tool.snakeToCamel': '底線轉駝峰',
    'plugins.textTools.tool.base64Encode': 'Base64 編碼',
    'plugins.textTools.tool.base64Decode': 'Base64 解碼',
    'plugins.textTools.tool.jsonBeautify': 'JSON 美化',
    'plugins.textTools.tool.jsonMinify': 'JSON 壓縮',
    'plugins.textTools.tool.timestampToDate': '時間戳轉日期',
    'plugins.textTools.tool.dateToTimestamp': '日期轉時間戳',
    'plugins.textTools.tool.decToHex': '十進位轉十六進位',
    'plugins.textTools.tool.hexToDec': '十六進位轉十進位',
    'plugins.textTools.error.unknownTool': '未知工具',
    'plugins.textTools.error.invalidInput': '輸入無效，無法處理',
    ...
    'toast.history.restored': '已還原到編輯器，儲存後生效',
    'toast.history.empty': '尚無歷史',
    ...
    'sessions.batch.select': '批次刪除',
    'sessions.batch.exit': '退出選擇',
    'sessions.batch.selectAll': '全選',
    'sessions.batch.unselectAll': '取消全選',
    'sessions.batch.deleteSelected': '刪除選中',
    'sessions.batch.deleteSelectedN': '刪除選中（{count}）',
    'sessions.batch.deletingSelected': '刪除中...',
    'sessions.batch.deleteConfirm': '確定刪除選中的 {count} 個會話嗎？',
    'sessions.batch.deleteConfirmHard': '確定永久刪除選中的 {count} 個會話嗎？該操作不可還原。',
    'sessions.batch.deleteHint': '已選 {count} 個',
    'sessions.batch.emptySelection': '請先選擇要刪除的會話',
    'sessions.batch.partialFail': '其中 {failed} 個刪除失敗，已保留選中',
    'sessions.batch.allFail': '刪除失敗，請重試',
    ...
    'usage.kpi.tokens': '總 Token',
    'usage.kpi.sessions': '會話數',
    'usage.kpi.messages': '訊息數',
    ...
    'config.localBridge.poolSettings': '輪詢池設定',
    'config.localBridge.poolHint': '選擇參與負載均衡的候選提供商。',
    'config.localBridge.noProviders': '暫無可用候選提供商，請先新增直連提供商。',
    'config.transformProvider.title': '使用轉換提供商',
    'config.providerBridgeHint': '{label} 橋接模式',
    ...
    'status.kilocodeProvider': 'Kilocode 供應商',
    'status.kilocodeModel': 'Kilocode 模型',
    'status.piProvider': 'Pi 供應商',
    ...
    'settings.trash.count': '共 {count} 項',
    'settings.trash.retentionShort': '保留 {days} 天',
    'settings.trash.disabled': '回收站已關閉',
    'settings.trash.disabledHint': '已刪除的工作階段將直接永久刪除，不再進入回收站。',
    'settings.trash.clearShort': '清空',
    'settings.trash.loadMoreItems': '載入更多（剩餘 {count} 項）',
...
,
    ...
    'side.config.kilocode.meta': '提供者',
    'toolConfig.kilocode.title': 'KiloCode 設定寫入與啟動',
    'toolConfig.kilocode.desc': '預設唯讀；啟用後可寫入 KiloCode 設定並從 Web 啟動。',
    'toolConfig.kilocode.lockedTitle': '唯讀模式',
    'toolConfig.kilocode.lockedDesc': '啟用寫入權限後可自動同步設定或啟動 KiloCode。',
    'toolConfig.kilocode.confirmMessage': '開啟後，KiloCode tab 內的操作會寫入 ~/.config/kilo/kilo.jsonc 或既有的 kilo.json，並可啟動本機 KiloCode。',
    'toolConfig.openclaw.title': 'OpenClaw 設定寫入',
    'toolConfig.openclaw.desc': '預設唯讀；啟用後可套用 OpenClaw 設定並寫入 AGENTS.md 與其他工作區檔案。',
    'toolConfig.openclaw.confirmMessage': '開啟後，OpenClaw tab 內的操作會寫入 openclaw.json 及 OpenClaw 工作區檔案（AGENTS.md、SOUL.md 等）。',
    'toolConfig.openclaw.lockedTitle': 'OpenClaw 目前為唯讀',
    'toolConfig.openclaw.lockedDesc': '這裡不會寫入 OpenClaw 設定。要套用設定或編輯工作區檔案，請先開啟本 tab 的寫入開關。',
    'side.config.pi': 'Pi',
    'side.config.pi.meta': '設定',
    'toolConfig.pi.title': 'Pi 設定寫入',
    'toolConfig.pi.desc': '預設唯讀；開啟後可同步 Pi 設定。',
    'toolConfig.pi.lockedTitle': '唯讀模式',
    'toolConfig.pi.lockedDesc': '開啟寫入權限後可同步 Pi 設定。',
    'toolConfig.pi.confirmMessage': '開啟後，Pi tab 內的操作會寫入 ~/.pi/config.json 或專案內的 ./.pi/config.json。',
    'pi.status.readOnly': '唯讀',
    'pi.config.openGlobal': '打開全域設定',
    'pi.providers.title': 'Pi 供應商',
    'pi.providers.subtitle': '管理 Piper 本地供應商與模型',
    'pi.providers.empty': '未找到 Piper 供應商，點擊新增開始。',
    'pi.providers.targetFile': 'Pi 生效設定檔：{path}',
    'pi.providers.editorTitle': '編輯供應商',
    ...
    'pi.providers.json.title': '設定 JSON',
    'pi.providers.json.desc': '即時預覽表單異動合併後的最終紀錄；儲存時併入 models.json。',
    ...
    'pi.providers.models.remoteLoading': '正在取得遠端模型清單…',
    'pi.providers.models.remoteFailed': '可手動輸入模型 ID。',
    'pi.providers.models.noMatch': '無符合模型',
    'pi.providers.models.importTitle': '從端點匯入模型',
    'pi.providers.models.addSelected': '新增選取（{count}）',
    'pi.providers.models.name': '名稱',
    'pi.providers.models.reasoning': '支援推理',
    'pi.providers.models.contextWindow': '上下文視窗',
    'pi.providers.models.maxTokens': '最大輸出',
    'pi.providers.models.catalogFill': '自動填寫',
    'pi.providers.models.catalogFilling': '填寫中…',
    'pi.picker.searchPlaceholder': '搜尋供應商…',
    'pi.picker.group.custom': '自訂端點',
    'pi.picker.group.apiKey': 'API Key 服務商',
    'pi.picker.empty': '沒有符合的供應商範本',
    'pi.picker.back': '返回選擇範本',
    'pi.providers.delete': '刪除供應商',
    'pi.providers.addModal.title': '新增供應商',
    'pi.providers.addModal.subtitle': '建立新的 Piper 供應商',
    'pi.providers.addModal.fields.baseUrl': 'Base URL',
    'pi.providers.addModal.fields.apiKey': 'API Key',
    'pi.providers.addModal.api.openaiCompletions': 'OpenAI Chat Completions（最相容）',
    ...
    'pi.providers.addModal.fields.api': '介面格式',
    'kilocode.providerModel.title': 'KiloCode provider / 模型',
    'kilocode.connection.title': 'KiloCode 連線',
    'kilocode.targetFile': 'KiloCode 生效設定：{path} · {status}',
    'kilocode.saveConfig': '儲存設定',
    'kilocode.start': '啟動 KiloCode',
    'kilocode.starting': '啟動中',
    'kilocode.saveAndStart': '儲存並啟動',
    'kilocode.summary.title': '目前 KiloCode provider',
    'kilocode.configPreview.title': 'KiloCode 設定預覽',
    'kilocode.configPreview.hint': 'API Key 已遮罩；自動同步會寫入真實 key。',
    'kilocode.saveFailed': '儲存 KiloCode 設定失敗',
    'kilocode.fillRequired': '請填寫 KiloCode URL 與 API Key',
    'kilocode.writeRequired': '請先開啟 KiloCode 寫入開關',
    'kilocode.saved': 'KiloCode 設定已儲存',
    'kilocode.autoSaved': 'KiloCode 設定已同步',
    'sysPrompt.scope.label': '作用域',
    'sysPrompt.scope.global': '全域 (~/.pi/agent/)',
    'sysPrompt.scope.project': '專案 (<cwd>/.pi/)',
    'sysPrompt.mode.label': '模式',
    'sysPrompt.mode.append': '追加到預設提示詞 (APPEND_SYSTEM.md)',
    'sysPrompt.mode.system': '替換預設提示詞 (SYSTEM.md)',
    'sysPrompt.placeholder': '在此輸入 system prompt 內容…',
    'sysPrompt.hint.unsaved': '有未儲存的變更',
    'sysPrompt.hint.twoStepSave': '點擊預覽查看差異，確認後儲存。',
    'sysPrompt.toast.saved': 'System prompt 已儲存',
});

const zhTw = Object.freeze({
    ...
    'prompts.editor.toolbar': 'Markdown 工具列',
    'prompts.editor.bold': '粗體',
    'prompts.editor.list': '清單',
    'prompts.editor.code': '程式碼區塊',
    'prompts.editor.undo': '復原',
    'prompts.editor.previewToggle': '即時預覽',
    'prompts.editor.edit': '編輯',
    'prompts.editor.preview': '預覽',
    'prompts.editor.previewUnavailable': '預覽元件未載入（marked / DOMPurify 缺失），請重新整理頁面',
    'prompts.editor.previewEmpty': '尚無內容可預覽',
    ...
    'modal.agents.title.opencode': 'OpenCode AGENTS.md 編輯器',
    ...
    'modal.agents.hint.opencode': '儲存後會寫入 ~/.config/opencode/AGENTS.md。',

const zhTw = Object.freeze({
    ...
    'announcement.providerCache.open': '快取公告',
    'announcement.providerCache.title': '快取公告',
    'announcement.providerCache.subtitle': '這裡彙總 ~/.codexmate 內的 provider 快取狀態；可從目前配置同步快取記錄。敏感欄位只顯示遮罩值。',
    'announcement.providerCache.summary.files': '快取檔案',
    'announcement.providerCache.summary.providers': 'Provider',
    'announcement.providerCache.summary.groups': '分組',
    'announcement.providerCache.groupList': '快取分組摘要',
    'announcement.providerCache.groupSummary': '{files} 檔案 · {providers} provider',
    'announcement.providerCache.details': '查看詳情',

const zhTw = Object.freeze({
    ...
    'announcement.project.title': 'Codex Mate 快速指南',
    'announcement.project.subtitle': '用一分鐘建立對目前工作台的認知：它把配置、會話、用量、任務、Skills 和資料維護收在同一個地方。',
    'announcement.project.features.aria': 'Codex Mate 功能概覽',
    'announcement.project.feature.config.title': '統一配置',
    'announcement.project.feature.config.meta': '管理 Codex / Claude / OpenClaw / OpenCode 的 Provider、模型與本地配置。',
    'announcement.project.feature.sessions.title': '會話瀏覽',
    'announcement.project.feature.sessions.meta': '按來源查看、搜尋、匯出、清理會話，快速回到上下文。',
    'announcement.project.feature.usage.title': '用量統計',
    'announcement.project.feature.usage.meta': '查看近 7 天、30 天或全部本地用量趨勢。',
    'announcement.project.feature.tasks.title': '任務編排',
    'announcement.project.feature.tasks.meta': '把複雜工作拆成計畫、佇列和執行記錄，方便追蹤。',
    'announcement.project.feature.skills.title': 'Skills / 外掛',
    'announcement.project.feature.skills.meta': '管理本地 Skills 與提示詞範本，讓常用工作流可複用。',
    'announcement.project.feature.data.title': '資料維護',
    'announcement.project.feature.data.meta': '處理備份、匯入、回收站和 Provider 快取同步。',
    'announcement.project.status.aria': '目前工作台狀態',
    'announcement.project.status.provider': '目前 Provider',
    'announcement.project.status.model': '目前模型',
    'announcement.project.status.cacheFiles': '快取檔案',
    'announcement.project.cache.title': 'Provider 快取同步',
    'announcement.project.cache.meta': '快取摘要只是健康狀態的一部分：同步後可被 Claude / Codex / OpenCode 配置視圖複用，敏感欄位繼續遮罩。',

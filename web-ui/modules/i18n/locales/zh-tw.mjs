const zhTw = Object.freeze({
    ...
    'side.prompts.presets.meta': '複用 Prompt 預設',
    ...
    'prompts.presets.applyAgents': '套用到 AGENTS.md',
    'prompts.presets.applyClaude': '套用到 CLAUDE.md',
    ...
    'prompts.presets.confirm.addCurrentMessage': '將目前編輯器內容以「{name}」加入預設池。不會保存 md 檔案。',
    ...
    'prompts.presets.confirm.applyTitle': '替換目前編輯器內容？',
    'prompts.presets.confirm.applyMessage': '目前編輯器存在未保存改動。套用預設會替換編輯器內容，但不會寫入文件，仍需點擊保存。',
    'prompts.presets.confirm.applyConfirm': '套用預設',
    ...
    'prompts.presets.toast.applied': '預設已套用到編輯器，點擊保存後才會寫入文件。',

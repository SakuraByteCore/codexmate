const ja = Object.freeze({
    ...
    'announcement.project.title': 'Codex Mate クイックガイド',
    'announcement.project.subtitle': '1 分で現在のワークスペースを把握できます。設定、セッション、使用量、タスク、Skills、データ保守を一か所にまとめています。',
    'announcement.project.features.aria': 'Codex Mate 機能概要',
    'announcement.project.feature.config.title': '統合設定',
    'announcement.project.feature.config.meta': 'Codex / Claude / OpenClaw / OpenCode の Provider、モデル、ローカル設定を管理します。',
    'announcement.project.feature.sessions.title': 'セッション閲覧',
    'announcement.project.feature.sessions.meta': 'ソース別にセッションを閲覧、検索、エクスポート、整理し、文脈へ戻りやすくします。',
    'announcement.project.feature.usage.title': '使用量分析',
    'announcement.project.feature.usage.meta': '直近 7 日、30 日、または全期間のローカル使用量トレンドを確認します。',
    'announcement.project.feature.tasks.title': 'タスク編成',
    'announcement.project.feature.tasks.meta': '複雑な作業を計画、キュー、実行記録に分けて追跡しやすくします。',
    'announcement.project.feature.skills.title': 'Skills / プラグイン',
    'announcement.project.feature.skills.meta': 'ローカル Skills とプロンプトテンプレートを管理し、反復作業を再利用できます。',
    'announcement.project.feature.data.title': 'データ保守',
    'announcement.project.feature.data.meta': 'バックアップ、インポート、ゴミ箱、Provider キャッシュ同期を扱います。',
    'announcement.project.status.aria': '現在のワークスペース状態',
    'announcement.project.status.provider': '現在の Provider',
    'announcement.project.status.model': '現在のモデル',
    'announcement.project.status.cacheFiles': 'キャッシュファイル',
    'announcement.project.cache.title': 'Provider キャッシュ同期',
    'announcement.project.cache.meta': 'キャッシュ概要は状態把握の一部です。同期後、Claude / Codex / OpenCode の設定ビューで再利用でき、機密フィールドはマスクされます。',

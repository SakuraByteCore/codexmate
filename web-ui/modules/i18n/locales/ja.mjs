const ja = Object.freeze({
    ...
    'prompts.editor.bold': '太字',
    'prompts.editor.list': 'リスト',
    'prompts.editor.code': 'コードブロック',
    'prompts.editor.undo': '元に戻す',
    'prompts.editor.previewToggle': 'ライブプレビュー',
    'prompts.editor.edit': '編集',
    'prompts.editor.preview': 'プレビュー',
    'prompts.editor.previewUnavailable': 'プレビュー用コンポーネント（marked / DOMPurify）が読み込まれていません。ページを再読み込みしてください',
    ...
    'toast.agents.saved.opencode': 'OpenCode AGENTS.md 保存しました',
    ...
    'modal.agents.title.opencode': 'OpenCode AGENTS.md エディタ',
    ...
    'modal.agents.hint.opencode': '保存すると ~/.config/opencode/AGENTS.md に書き込まれます。',

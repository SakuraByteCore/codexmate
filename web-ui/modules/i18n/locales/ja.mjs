const ja = Object.freeze({
    ...
    'announcement.providerCache.open': 'キャッシュ通知',
    'announcement.providerCache.title': 'キャッシュ通知',
    'announcement.providerCache.subtitle': '~/.codexmate 配下の provider キャッシュ状態を要約します。現在の設定からキャッシュ記録を同期でき、機密フィールドはマスク表示のままです。',
    'announcement.providerCache.summary.files': 'キャッシュファイル',
    'announcement.providerCache.summary.providers': 'Provider',
    'announcement.providerCache.summary.groups': 'グループ',
    'announcement.providerCache.groupList': 'キャッシュグループ概要',
    'announcement.providerCache.groupSummary': '{files} ファイル · {providers} provider',
    'announcement.providerCache.details': '詳細を見る',

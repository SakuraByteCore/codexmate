const ja = Object.freeze({
    ...
    'opencode.applySelection': '選択を適用',
    'opencode.targetFile': '対象ファイル: {path} · {status}',
    ...
    'opencode.configFile.hint': '既存の OpenCode JSON/JSONC 設定をインポートできます。保存前に解析し、不正な設定の書き込みを防ぎます。',

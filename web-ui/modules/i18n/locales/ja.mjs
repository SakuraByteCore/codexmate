const ja = Object.freeze({
    ...
    'prompts.presets.applyAgents': 'AGENTS.md に適用',
    'prompts.presets.applyClaude': 'CLAUDE.md に適用',
    ...
    'prompts.presets.confirm.addCurrentMessage': '現在のエディター内容を「{name}」としてプリセットプールに追加します。md ファイルは保存されません。',
    ...
    'prompts.presets.confirm.applyTitle': '現在のエディター内容を置き換えますか？',
    'prompts.presets.confirm.applyMessage': '現在のエディターには未保存の変更があります。プリセットを適用するとエディター内容は置き換わりますが、保存をクリックするまでファイルには書き込まれません。',
    'prompts.presets.confirm.applyConfirm': 'プリセットを適用',
    ...
    'prompts.presets.toast.applied': 'プリセットをエディターへ適用しました。ファイルへ書き込むには保存してください。',

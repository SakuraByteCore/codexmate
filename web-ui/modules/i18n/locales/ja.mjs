const ja = Object.freeze({
    ...
    'side.plugins.pluginsCount': '{count} 件のプラグイン',
    ...
    'plugins.catalog.textTools.title': 'テキストツール',
    'plugins.catalog.textTools.description': '開発者向け文字列ツール：空白圧縮、重複削除・ソート・反転、大文字小文字変換、Base64、JSON、タイムスタンプ・基数変換。',
    'plugins.textTools.title': 'テキストツール',
    'plugins.textTools.inputLabel': '入力',
    'plugins.textTools.inputPlaceholder': 'ここにテキストを貼り付け・入力...',
    'plugins.textTools.outputLabel': '出力',
    'plugins.textTools.outputPlaceholder': '結果がここに表示されます',
    'plugins.textTools.swap': '入出力を入れ替え',
    'plugins.textTools.clear': 'クリア',
    'plugins.textTools.stats.chars': '文字',
    'plugins.textTools.stats.lines': '行',
    'plugins.textTools.stats.words': '単語',
    'plugins.textTools.stats.bytes': 'バイト',
    'plugins.textTools.group.whitespace': '空白 / 圧縮',
    'plugins.textTools.group.text': 'テキスト処理',
    'plugins.textTools.group.case': '大文字小文字',
    'plugins.textTools.group.encode': 'エンコード',
    'plugins.textTools.group.format': 'フォーマット',
    'plugins.textTools.group.convert': '変換',
    'plugins.textTools.tool.removeSpaces': '空白を削除',
    'plugins.textTools.tool.removeNewlines': '改行を削除',
    'plugins.textTools.tool.removeBlankLines': '空行を削除',
    'plugins.textTools.tool.removeCR': 'CR を削除',
    'plugins.textTools.tool.removeTabs': 'タブを削除',
    'plugins.textTools.tool.compressAll': 'すべての空白を圧縮',
    'plugins.textTools.tool.dedupeLines': '行の重複を削除',
    'plugins.textTools.tool.sortLines': '行をソート',
    'plugins.textTools.tool.reverseText': 'テキストを反転',
    'plugins.textTools.tool.toUpperCase': '大文字に変換',
    'plugins.textTools.tool.toLowerCase': '小文字に変換',
    'plugins.textTools.tool.titleCase': '先頭大文字',
    'plugins.textTools.tool.camelToSnake': 'キャメルケース→スネークケース',
    'plugins.textTools.tool.snakeToCamel': 'スネークケース→キャメルケース',
    'plugins.textTools.tool.base64Encode': 'Base64 エンコード',
    'plugins.textTools.tool.base64Decode': 'Base64 デコード',
    'plugins.textTools.tool.jsonBeautify': 'JSON 整形',
    'plugins.textTools.tool.jsonMinify': 'JSON 圧縮',
    'plugins.textTools.tool.timestampToDate': 'タイムスタンプ→日時',
    'plugins.textTools.tool.dateToTimestamp': '日時→タイムスタンプ',
    'plugins.textTools.tool.decToHex': '10進数→16進数',
    'plugins.textTools.tool.hexToDec': '16進数→10進数',
    'plugins.textTools.error.unknownTool': '不明なツール',
    'plugins.textTools.error.invalidInput': '入力が無効です',
    ...
    'usage.kpi.tokens': '合計 Token',
    'usage.kpi.sessions': 'セッション数',
    'usage.kpi.messages': 'メッセージ数',
    'usage.kpi.dailyAvg': '1 日あたり Token',
    'usage.kpi.busiestDay': '最も忙しい日',
    'usage.wave.summary': '合計 {total} · ピーク {peakDay}（{peakValue}）',
    ...
    'status.kilocodeProvider': 'Kilocode プロバイダー',
    'status.kilocodeModel': 'Kilocode モデル',
    'status.piProvider': 'Pi プロバイダー',
    'status.piModel': 'Pi モデル',
    ...
    'pi.providers.json.desc': 'フォーム変更と拡張フィールドを統合した最終レコードをリアルタイムにプレビュー。保存時に models.json へ統合します。',
    ...
    'pi.providers.models.importTitle': 'エンドポイントからモデルをインポート',
    'pi.providers.models.addSelected': '選択済みを追加（{count}）',
    'pi.providers.models.name': '名前',
    'pi.providers.models.reasoning': '推論をサポート',
    'pi.providers.models.contextWindow': 'コンテキストウィンドウ',
    'pi.providers.models.maxTokens': '最大出力',
    'pi.providers.models.catalogFill': '自動入力',
    'pi.providers.models.catalogFilling': '入力中…',
    'pi.picker.searchPlaceholder': 'プロバイダーを検索…',
    'pi.picker.group.custom': 'カスタムエンドポイント',
    'pi.picker.group.apiKey': 'API キープロバイダー',
    'pi.picker.empty': '一致するプロバイダーテンプレートがありません',
    'pi.picker.back': 'テンプレート選択に戻る',
    ...
    'pi.providers.addModal.api.openaiCompletions': 'OpenAI Chat Completions（最も互換性が高い）',

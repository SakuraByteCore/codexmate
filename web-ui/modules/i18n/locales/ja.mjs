const ja = Object.freeze({
    ...
    'toolConfig.opencode.desc': '既定では OpenCode 設定を読み取り専用で表示します。有効化した場合のみ ~/.opencode.json に書き込みます。',
    ...
    'toolConfig.opencode.confirmMessage': '有効化すると、OpenCode タブ内の操作が ~/.opencode.json または XDG OpenCode 設定ファイルを書き込みます。',

const vi = Object.freeze({
    ...
    'prompts.subTab.opencode': 'AGENTS.md (OpenCode)',
    ...
    'prompts.editor.bold': 'In đậm',
    'prompts.editor.list': 'Danh sách',
    'prompts.editor.code': 'Khối mã',
    'prompts.editor.undo': 'Hoàn tác',
    'prompts.editor.previewToggle': 'Xem trước trực tiếp',
    'prompts.editor.edit': 'Chỉnh sửa',
    'prompts.editor.preview': 'Xem trước',
    'prompts.editor.previewUnavailable': 'Thư viện xem trước (marked / DOMPurify) chưa được tải, hãy tải lại trang',
    ...
    'toast.agents.saved.opencode': 'OpenCode AGENTS.md đã lưu',
    ...
    'modal.agents.title.opencode': 'Trình soạn thảo AGENTS.md OpenCode',
    ...
    'modal.agents.hint.opencode': 'Nội dung đã lưu sẽ được ghi vào ~/.config/opencode/AGENTS.md.',

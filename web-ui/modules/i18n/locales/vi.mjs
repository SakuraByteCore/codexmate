const vi = Object.freeze({
    ...
    'usage.kpi.filesChanged': 'Tệp đã sửa',
    'usage.kpi.linesChanged': 'Dòng mã',
    'usage.kpi.statsCoverage': 'Đã thống kê {computed}/{total}',
    'usage.kpi.statsUnavailable': 'Không có thống kê',

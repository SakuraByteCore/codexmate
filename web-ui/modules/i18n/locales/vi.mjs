const vi = Object.freeze({
    ...
    'side.plugins.pluginsCount': '{count} plugin',
    ...
    'plugins.catalog.textTools.title': 'Công cụ văn bản',
    'plugins.catalog.textTools.description': 'Bộ công cụ chuỗi dành cho nhà phát triển: nén khoảng trắng, loại bỏ trùng lặp/sắp xếp/đảo ngược, chuyển đổi chữ hoa/thường, Base64, JSON, dấu thời gian và hệ cơ số.',
    'plugins.textTools.title': 'Công cụ văn bản',
    'plugins.textTools.inputLabel': 'Đầu vào',
    'plugins.textTools.inputPlaceholder': 'Dán hoặc nhập văn bản tại đây...',
    'plugins.textTools.outputLabel': 'Đầu ra',
    'plugins.textTools.outputPlaceholder': 'Kết quả sẽ hiển thị tại đây',
    'plugins.textTools.swap': 'Hoán đổi đầu vào/ra',
    'plugins.textTools.clear': 'Xóa',
    'plugins.textTools.stats.chars': 'Ký tự',
    'plugins.textTools.stats.lines': 'Dòng',
    'plugins.textTools.stats.words': 'Từ',
    'plugins.textTools.stats.bytes': 'Byte',
    'plugins.textTools.group.whitespace': 'Khoảng trắng',
    'plugins.textTools.group.text': 'Văn bản',
    'plugins.textTools.group.case': 'Chữ hoa/thường',
    'plugins.textTools.group.encode': 'Mã hóa',
    'plugins.textTools.group.format': 'Định dạng',
    'plugins.textTools.group.convert': 'Chuyển đổi',
    'plugins.textTools.tool.removeSpaces': 'Xóa khoảng trắng',
    'plugins.textTools.tool.removeNewlines': 'Xóa dấu xuống dòng',
    'plugins.textTools.tool.removeBlankLines': 'Xóa dòng trống',
    'plugins.textTools.tool.removeCR': 'Xóa CR',
    'plugins.textTools.tool.removeTabs': 'Xóa tab',
    'plugins.textTools.tool.compressAll': 'Nén tất cả khoảng trắng',
    'plugins.textTools.tool.dedupeLines': 'Loại bỏ dòng trùng',
    'plugins.textTools.tool.sortLines': 'Sắp xếp dòng',
    'plugins.textTools.tool.reverseText': 'Đảo ngược văn bản',
    'plugins.textTools.tool.toUpperCase': 'Chuyển thành chữ hoa',
    'plugins.textTools.tool.toLowerCase': 'Chuyển thành chữ thường',
    'plugins.textTools.tool.titleCase': 'Viết hoa đầu từ',
    'plugins.textTools.tool.camelToSnake': 'camelCase sang snake_case',
    'plugins.textTools.tool.snakeToCamel': 'snake_case sang camelCase',
    'plugins.textTools.tool.base64Encode': 'Mã hóa Base64',
    'plugins.textTools.tool.base64Decode': 'Giải mã Base64',
    'plugins.textTools.tool.jsonBeautify': 'Làm đẹp JSON',
    'plugins.textTools.tool.jsonMinify': 'Nén JSON',
    'plugins.textTools.tool.timestampToDate': 'Dấu thời gian sang ngày',
    'plugins.textTools.tool.dateToTimestamp': 'Ngày sang dấu thời gian',
    'plugins.textTools.tool.decToHex': 'Thập phân sang hex',
    'plugins.textTools.tool.hexToDec': 'Hex sang thập phân',
    'plugins.textTools.error.unknownTool': 'Công cụ không xác định',
    'plugins.textTools.error.invalidInput': 'Đầu vào không hợp lệ',
    ...
    'usage.kpi.tokens': 'Tổng token',
    'usage.kpi.sessions': 'Số phiên',
    'usage.kpi.messages': 'Số tin nhắn',
    'usage.kpi.dailyAvg': 'Token trung bình/ngày',
    'usage.kpi.busiestDay': 'Ngày bận nhất',
    'usage.wave.summary': 'Tổng {total} · đỉnh {peakDay} ({peakValue})',
    ...
    'status.kilocodeProvider': 'Nhà cung cấp Kilocode',
    'status.kilocodeModel': 'Mô hình Kilocode',
    'status.piProvider': 'Nhà cung cấp Pi',
    'status.piModel': 'Mô hình Pi',
    ...
    'pi.providers.json.title': 'Cấu hình JSON',
    'pi.providers.json.desc': 'Xem trước bản ghi cuối từ thay đổi biểu mẫu; các chỉnh sửa được gộp vào models.json khi lưu.',
    ...
    'pi.providers.models.importTitle': 'Nhập mô hình từ endpoint',
    'pi.providers.models.addSelected': 'Thêm đã chọn ({count})',
    'pi.providers.models.name': 'Tên',
    'pi.providers.models.reasoning': 'Hỗ trợ suy luận',
    'pi.providers.models.contextWindow': 'Cửa sổ ngữ cảnh',
    'pi.providers.models.maxTokens': 'Đầu ra tối đa',
    'pi.providers.models.catalogFill': 'Tự động điền',
    'pi.providers.models.catalogFilling': 'Đang điền…',
    'pi.picker.searchPlaceholder': 'Tìm kiếm nhà cung cấp…',
    'pi.picker.group.custom': 'Endpoint tùy chỉnh',
    'pi.picker.group.apiKey': 'Nhà cung cấp API key',
    'pi.picker.empty': 'Không có mẫu nhà cung cấp phù hợp',
    'pi.picker.back': 'Quay lại chọn mẫu',
    ...
    'pi.providers.addModal.fields.apiKey': 'API Key',
    'pi.providers.addModal.api.openaiCompletions': 'OpenAI Chat Completions (tương thích nhất)',
    'pi.providers.addModal.api.openaiResponses': 'OpenAI Responses API',
    'pi.providers.addModal.api.anthropicMessages': 'Anthropic Messages API',
    'pi.providers.addModal.api.googleGenerativeAi': 'Google Generative AI',

const vi = Object.freeze({
    ...
    'announcement.project.title': 'Hướng dẫn nhanh Codex Mate',
    'announcement.project.subtitle': 'Nắm bức tranh làm việc trong một phút: workspace này gom cấu hình, phiên, mức dùng, tác vụ, Skills và bảo trì dữ liệu vào một nơi.',
    'announcement.project.features.aria': 'Tổng quan tính năng Codex Mate',
    'announcement.project.feature.config.title': 'Cấu hình thống nhất',
    'announcement.project.feature.config.meta': 'Quản lý provider, model và cấu hình cục bộ cho Codex, Claude, OpenClaw và OpenCode.',
    'announcement.project.feature.sessions.title': 'Trình duyệt phiên',
    'announcement.project.feature.sessions.meta': 'Xem, tìm kiếm, xuất và dọn phiên theo nguồn để khôi phục ngữ cảnh nhanh hơn.',
    'announcement.project.feature.usage.title': 'Thống kê mức dùng',
    'announcement.project.feature.usage.meta': 'Xem xu hướng sử dụng cục bộ trong 7 ngày, 30 ngày hoặc toàn bộ thời gian.',
    'announcement.project.feature.tasks.title': 'Điều phối tác vụ',
    'announcement.project.feature.tasks.meta': 'Chia việc phức tạp thành kế hoạch, hàng đợi và bản ghi chạy để dễ theo dõi.',
    'announcement.project.feature.skills.title': 'Skills / Plugin',
    'announcement.project.feature.skills.meta': 'Quản lý Skills cục bộ và mẫu prompt để tái sử dụng workflow lặp lại.',
    'announcement.project.feature.data.title': 'Bảo trì dữ liệu',
    'announcement.project.feature.data.meta': 'Xử lý sao lưu, nhập dữ liệu, thùng rác và đồng bộ bộ nhớ đệm provider.',
    'announcement.project.status.aria': 'Trạng thái workspace hiện tại',
    'announcement.project.status.provider': 'Provider hiện tại',
    'announcement.project.status.model': 'Model hiện tại',
    'announcement.project.status.cacheFiles': 'Tệp bộ nhớ đệm',
    'announcement.project.cache.title': 'Đồng bộ bộ nhớ đệm provider',
    'announcement.project.cache.meta': 'Tóm tắt bộ nhớ đệm chỉ là một tín hiệu trạng thái. Sau khi đồng bộ, các màn hình cấu hình Claude / Codex / OpenCode có thể dùng lại bản ghi này và trường nhạy cảm vẫn được che.',

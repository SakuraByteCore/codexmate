const vi = Object.freeze({
    ...
    'opencode.applySelection': 'Áp dụng lựa chọn',
    'opencode.targetFile': 'File đích: {path} · {status}',
    ...
    'opencode.configFile.hint': 'Hỗ trợ nhập cấu hình OpenCode JSON/JSONC hiện có; nội dung sẽ được phân tích trước khi lưu để tránh ghi cấu hình lỗi.',

const vi = Object.freeze({
    ...
    'prompts.presets.applyAgents': 'Áp dụng vào AGENTS.md',
    'prompts.presets.applyClaude': 'Áp dụng vào CLAUDE.md',
    ...
    'prompts.presets.confirm.addCurrentMessage': 'Thêm nội dung trình soạn thảo hiện tại vào kho preset với tên “{name}”. Thao tác này không lưu tệp md.',
    ...
    'prompts.presets.confirm.applyTitle': 'Thay nội dung editor hiện tại?',
    'prompts.presets.confirm.applyMessage': 'Editor hiện có thay đổi chưa lưu. Áp dụng preset sẽ thay nội dung editor, nhưng chưa ghi tệp cho tới khi bạn bấm Lưu.',
    'prompts.presets.confirm.applyConfirm': 'Áp dụng preset',
    ...
    'prompts.presets.toast.applied': 'Đã áp dụng preset vào editor. Bấm Lưu để ghi tệp.',

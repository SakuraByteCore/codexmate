...
export function normalizeClaudeConfig(config) {
    ...
    return {
        ...
        haikuModel: normalizeClaudeValue(safe.haikuModel),
        sonnetModel: normalizeClaudeValue(safe.sonnetModel),
        opusModel: normalizeClaudeValue(safe.opusModel),
        authToken,
        useKey,
...
export function normalizeClaudeSettingsEnv(env) {
    ...
    return {
        ...
        haikuModel: normalizeClaudeValue(safe.ANTHROPIC_DEFAULT_HAIKU_MODEL),
        sonnetModel: normalizeClaudeValue(safe.ANTHROPIC_DEFAULT_SONNET_MODEL),
        opusModel: normalizeClaudeValue(safe.ANTHROPIC_DEFAULT_OPUS_MODEL),
        authToken,
        useKey,

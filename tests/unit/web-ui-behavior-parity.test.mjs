...
test('captured bundled app skeleton only exposes expected data key drift versus parity baseline', () => {
    ...
    const allowedExtraCurrentMethodKeys = [
        ...
        'formatPromptPresetTime',
        'getPromptPresetRenameDraft',
